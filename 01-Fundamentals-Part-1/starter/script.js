...
// const orkhan = "I'm " + firstName + ", a " 
// + (year - birthYear) + ' year old ' + job + '!'

// console.log(orkhan);

// const orkhanNew = `I'm ${d=firstName}, a ${year - birthYear} year old ${job}!`;
...
// const money = 0;
// if(money){      //  js automatically convert number to boolean because of if
...
// if(favourite !== 23){ // != loose different
